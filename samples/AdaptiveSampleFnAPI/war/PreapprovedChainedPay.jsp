...
<form method="POST">
<input type="hidden" name="action" value="preapprovedChainedPay"/>
<center>
<table class="api">
	<tr>
		<td colspan="4" class="header">Preapproved Chained Pay</td>
	</tr>
		
	<tr>
		<td class="thinfield">PreapprovalKey:</td>
		<td><input type="text" size="50" name="preapprovalKey" value="PA-3R134232B90885619" /></td>
	</tr>	
	<tr>
		<td class="thinfield">Primary Receiver Email:</td>
		<td><input type="text" size="50" name="primaryReceiverEmail" value="pp+sel_1261964325_biz@yahoo.com" /></td>
		<td class="thinfield">Amount:</td>
		<td><input type="text" name="primaryReceiverAmount" value="4.0"></td>
	</tr>
	<tr>
		<td class="thinfield">Select number of Secondary Receivers:</td>
		<td colspan=3>
			<select name="numberOfSecondaryReceivers">
	...
	<tr>
		<td class="thinfield">Secondary Receiver Email:</td>
		<td><input type="text" size="50" name="receiveremail" value="p11_1266546062_biz@yahoo.com" /></td>
		<td class="thinfield">Amount:</td>
	...
	<tr>
		...
		<%
		 for(PaymentType ptype: PaymentType.values()){
			 if(ptype != PaymentType.PERSONAL && ptype != PaymentType.CASHADVANCE){
