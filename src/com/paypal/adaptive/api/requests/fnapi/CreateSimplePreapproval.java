...
/**
 * <p> Java class to create simple preapproval.
 *
 */
public class CreateSimplePreapproval {
	...
	throws MissingParameterException,RequestAlreadyMadeException {
		...
		if(maxNumberOfPayments <= 0){
			// throw error
			throw new MissingParameterException("maxNumberOfPayments");
		}
	...
	throws IOException, MalformedURLException, MissingAPICredentialsException,
		...
		preapprovalDetails.setMaxNumberOfPayments(maxNumberOfPayments);
		if(pinType != null)
